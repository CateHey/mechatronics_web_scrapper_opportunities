...
export const COMPANIES: Company[] = [
  ...
  // ---------------- AUSTRALIA ----------------
  {
    ...
    ats: "PageUp People",
    method:
      "Mismo sitemap.xml de careers.mmg.com, filtrando las vacantes ubicadas en Australia (Dugald River, Melbourne, etc.).",
    reliability: "solida",
    careersUrl: "https://careers.mmg.com/caw/en/listing",
    links: [{ label: "Portal de empleos MMG", url: "https://careers.mmg.com/caw/en/listing" }],
  },
  {
    key: "bhp",
    name: "BHP",
    ...
    ats: "Workday",
    method:
      "API guest de LinkedIn filtrada a Australia como respaldo. BHP publica programas de Apprentice, Vacation y Graduate.",
    reliability: "respaldo",
    careersUrl: "https://careers.bhp.com/",
    links: [
      { label: "Portal de empleos BHP", url: "https://careers.bhp.com/" },
      { label: "BHP en LinkedIn", url: "https://au.linkedin.com/company/bhp/jobs" },
    ],
  },
  {
    key: "riotinto",
    ...
    ats: "Workday",
    method:
      "API guest de LinkedIn filtrada a Australia como respaldo. Rio Tinto tiene programas de Graduate y Apprenticeship.",
    reliability: "respaldo",
    careersUrl: "https://www.riotinto.com/en/careers",
    links: [
      { label: "Portal de empleos Rio Tinto", url: "https://www.riotinto.com/en/careers/jobs" },
      { label: "Rio Tinto en LinkedIn", url: "https://au.linkedin.com/company/rio-tinto/jobs" },
    ],
  },
  {
    key: "fortescue",
    ...
    ats: "Workday",
    method:
      "API guest de LinkedIn filtrada a Australia como respaldo. Fortescue impulsa roles de automatización y energía verde.",
    reliability: "respaldo",
    careersUrl: "https://fortescue.com/careers",
    links: [
      { label: "Portal de empleos Fortescue", url: "https://fortescue.com/careers" },
      { label: "Fortescue en LinkedIn", url: "https://au.linkedin.com/company/fortescue/jobs" },
    ],
  },
  {
    key: "woodside",
    ...
    ats: "Workday",
    method:
      "API guest de LinkedIn filtrada a Australia como respaldo. Woodside tiene programas Graduate y Vacation en ingeniería.",
    reliability: "respaldo",
    careersUrl: "https://www.woodside.com/careers",
    links: [
      { label: "Portal de empleos Woodside", url: "https://www.woodside.com/careers" },
      { label: "Woodside en LinkedIn", url: "https://au.linkedin.com/company/woodside/jobs" },
    ],
  },
];
